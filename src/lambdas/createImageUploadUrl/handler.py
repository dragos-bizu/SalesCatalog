...
POST /admin/images/upload-url — issue a presigned S3 PUT URL. Admin (Cognito JWT).
...
def lambda_handler(event, context):
    ...
    logger.info("createImageUploadUrl invoked (stub)")
    return {
        "statusCode": 501,
        "headers": {"Content-Type": "application/json"},
        "body": json.dumps({"message": "Not Implemented", "function": "createImageUploadUrl"}),
    }
