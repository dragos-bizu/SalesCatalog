...
DELETE /products/{id} — delete a product. Admin (Cognito JWT).
...
def lambda_handler(event, context):
    ...
    logger.info("deleteProduct invoked (stub)")
    return {
        "statusCode": 501,
        "headers": {"Content-Type": "application/json"},
        "body": json.dumps({"message": "Not Implemented", "function": "deleteProduct"}),
    }
