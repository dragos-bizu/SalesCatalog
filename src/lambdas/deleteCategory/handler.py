...
DELETE /categories/{id} — delete a category. Admin (Cognito JWT).
...
def lambda_handler(event, context):
    ...
    logger.info("deleteCategory invoked (stub)")
    return {
        "statusCode": 501,
        "headers": {"Content-Type": "application/json"},
        "body": json.dumps({"message": "Not Implemented", "function": "deleteCategory"}),
    }
