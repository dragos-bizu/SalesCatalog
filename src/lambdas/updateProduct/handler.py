...
PUT /products/{id} — update an existing product. Admin (Cognito JWT).
...
def lambda_handler(event, context):
    ...
    logger.info("updateProduct invoked (stub)")
    return {
        "statusCode": 501,
        "headers": {"Content-Type": "application/json"},
        "body": json.dumps({"message": "Not Implemented", "function": "updateProduct"}),
    }
