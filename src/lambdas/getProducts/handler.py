...
GET /products — list products (paginated, optional q + categoryId filters). Public.
...
def lambda_handler(event, context):
    ...
    logger.info("getProducts invoked (stub)")
    return {
        "statusCode": 501,
        "headers": {"Content-Type": "application/json"},
        "body": json.dumps({"message": "Not Implemented", "function": "getProducts"}),
    }
