...
POST /categories — create a new category. Admin (Cognito JWT).
...
def lambda_handler(event, context):
    ...
    logger.info("createCategory invoked (stub)")
    return {
        "statusCode": 501,
        "headers": {"Content-Type": "application/json"},
        "body": json.dumps({"message": "Not Implemented", "function": "createCategory"}),
    }
