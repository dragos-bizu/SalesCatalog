...
POST /products — create a new product. Admin (Cognito JWT).
...
def lambda_handler(event, context):
    ...
    logger.info("createProduct invoked (stub)")
    return {
        "statusCode": 501,
        "headers": {"Content-Type": "application/json"},
        "body": json.dumps({"message": "Not Implemented", "function": "createProduct"}),
    }
